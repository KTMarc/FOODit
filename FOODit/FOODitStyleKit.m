...
+ (void)drawMealcard__curve2WithFraction: (CGFloat)fraction
{
    ...
    //// Page-1
    {
        ...
        //// meal-card__curve 2
        {
            ...
            //// path- Drawing
            UIBezierPath* pathPath = UIBezierPath.bezierPath;
            [pathPath moveToPoint: CGPointMake(-0.03, 6.52)];
            [pathPath addCurveToPoint: CGPointMake(143.78, 0) controlPoint1: CGPointMake(39.68, 2.4) controlPoint2: CGPointMake(92.42, 0)];
            [pathPath addCurveToPoint: CGPointMake(282.59, 6.52) controlPoint1: CGPointMake(195.14, 0) controlPoint2: CGPointMake(242.88, 2.4)];
            [pathPath addLineToPoint: CGPointMake(284, 6.52)];
            [pathPath addLineToPoint: CGPointMake(284, 16.95)];
            [pathPath addLineToPoint: CGPointMake(4, 16.95)];
            [pathPath addLineToPoint: CGPointMake(4, 6.57)];
            [pathPath addLineToPoint: CGPointMake(-0.03, 6.52)];
            [pathPath closePath];
            pathPath.miterLimit = 4;
